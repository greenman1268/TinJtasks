...
import static hometasks.Chapter14.task9.Tuple.tuple;
...
public class TupleTest2 {
  ...
  static SixTouple<Vehicle,Amphibian,String,Integer,Double,Boolean> l() { return tuple(new Vehicle(), new Amphibian(), "hi", 47, 11.1, true);}
